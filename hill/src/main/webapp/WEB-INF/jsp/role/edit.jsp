...
<%@taglib prefix="sf" uri="http://www.bow.com/taglib/shiro-functions" %>
<html>
<head>
    <title></title>
...
<body>
    ...
    <form:form method="post" commandName="role">
        ...
        <div class="form-group">
            ...
            <input type="text" id="resourceName" name="resourceName" value="${sf:resourceNames(role.resourceIds)}" readonly>
    ...
    <script>
        $(function () {
            ...
            var zNodes =[
                ...
                { id:"${r.id}", pId:"${r.parentId}", name:"${r.name}", checked:"${sf:in(role.resourceIds, r.id)}"},
                </c:if>
                </c:forEach>
            ];
